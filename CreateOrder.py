...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clientLine = QtWidgets.QLineEdit(self.groupBoxOrder)
        self.clientLine.setGeometry(QtCore.QRect(90, 140, 181, 24))
        self.clientLine.setObjectName("clientLine")
        self.ExecutorLine = QtWidgets.QLineEdit(self.groupBoxOrder)
        self.ExecutorLine.setGeometry(QtCore.QRect(400, 140, 201, 24))
        self.ExecutorLine.setObjectName("ExecutorLine")
        ...
        self.ResultLine.setGeometry(QtCore.QRect(380, 230, 221, 31))
        ...
        self.addOrderBtn.clicked.connect(self.add_Order_to_table)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Добавить новый заказ"))
    ...
    def add_Order_to_table(self):
        ...
        ExecValue = self.ExecutorLine.text()
        CustValue = self.clientLine.text()
